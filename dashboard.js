...
// ===================== Katalog produk (dari catalog.js) =====================
// PRODUCTS, loadProducts(), searchProducts(), catalogStatusText() berasal dari catalog.js

function renderProducts(query) {
  const matches = searchProducts(query, 20);
  ...
  $('#prodContext').innerHTML = `Menampilkan <b>${matches.length}</b> hasil · ${catalogStatusText()}`;
}
